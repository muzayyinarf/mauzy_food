...
class RestaurantRemoteDatasource {
  Future<Either<String, ListRestaurantResponseModel>>
    ...
    final response =
        await http.get(Uri.parse('${GlobalVariables.baseUrl}/list'));
  ...
  Future<Either<String, DetailRestaurantResponseModel>> getDetailRestaurant(
      String id) async {
    final response =
        await http.get(Uri.parse('${GlobalVariables.baseUrl}/detail/$id'));
    if (response.statusCode == 200) {
  ...
  Future<Either<String, SearchRestaurantResponseModel>> searchRestaurant(
    ...
    final response =
        await http.get(Uri.parse('${GlobalVariables.baseUrl}/search?q=$query'));
    if (response.statusCode == 200) {
